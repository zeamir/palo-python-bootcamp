...
class SnackOrder(BaseModel):
    ...
    item_name: str = Field()  # TODO A: Prevent empty names
    price: float = Field()  # TODO B: Ensure positive prices
    quantity: int = Field()  # TODO C: Limit to reasonable quantities
    category: str = Field()  # TODO D: Allow only valid categories
